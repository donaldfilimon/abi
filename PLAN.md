...
- **GPU backend test coverage** - Added inline tests to WebGPU (error enums, buffer flags, device enumeration) and OpenGL (error enums, GL constants, availability checks) backends; Updated CLAUDE.md gotchas with @tagName/@errorName clarification and test import patterns; 787/792 tests passing (2026-01-30)
