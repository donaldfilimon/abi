...
- [x] **Streaming documentation** - API overview for SSE/WebSocket endpoints (`docs/content/api.html`)
- [x] **Model management guide** - Model workflow overview (`docs/content/ai.html`)
...
- **C-compatible library bindings** - Removed during cleanup; reimplementation planned per ROADMAP.md (2026-01-30)
