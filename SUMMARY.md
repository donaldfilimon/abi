...
ABI is a **Zig 0.17.0-dev.304+9787df942** framework for AI services, semantic vector storage, GPU acceleration, distributed runtime utilities, and MCP/ACP integration.
...
- Zig pin: see `.zigversion` (0.17.0-dev.304+9787df942).
