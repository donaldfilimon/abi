...
pub const guides = [_]model.GuideSpec{
    ...
    .{ .slug = "cli", .title = "CLI", .description = "30 commands and aliases for AI, GPU, database, and system management", .section = "Core", .order = 13, .permalink = "/cli/", .template_path = "tools/gendocs/templates/docs/cli.md.tpl" },
    .{ .slug = "migration-vnext", .title = "Migration (vNext)", .description = "Migration guide for upcoming breaking changes", .section = "Core", .order = 14, .permalink = "/migration-vnext/", .template_path = "tools/gendocs/templates/docs/migration-vnext.md.tpl" },
