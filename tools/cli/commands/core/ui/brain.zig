...
const brain_animation = @import("../../../terminal/brain_animation.zig");
const brain_panel = @import("../../../terminal/brain_panel.zig");
const metrics_file_reader = @import("../../../terminal/metrics_file_reader.zig");
const training_brain_mapper = @import("../../../terminal/training_brain_mapper.zig");
