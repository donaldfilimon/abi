...
fn printHelp(allocator: std.mem.Allocator) void {
    ...
    _ = builder
        ...
        .option(.{ .long = "--zls", .arg = "PATH", .description = "ZLS binary path override (default: .zig-bootstrap/bin/zls, then .cel/bin/zls, then PATH)" })
        .option(.{ .long = "--zig", .arg = "PATH", .description = "Zig compiler path override for ZLS (default: .zig-bootstrap/bin/zig, then .cel/bin/zig, then ZVM/PATH)" })
