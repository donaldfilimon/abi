...
/// Superset of shared.ProviderError with OpenAI-specific additions.
pub const OpenAIError = shared.ProviderError || error{
    MissingApiKey,
};
...
pub fn loadFromEnv(allocator: std.mem.Allocator) !Config {
    const loaded = try shared.loadConfigFromEnv(allocator, .{
        .api_key_env = &.{ "ABI_OPENAI_API_KEY", "OPENAI_API_KEY" },
        .base_url_env = &.{ "ABI_OPENAI_BASE_URL", "OPENAI_BASE_URL" },
        .model_env = &.{ "ABI_OPENAI_MODEL", "OPENAI_MODEL" },
