...
/// vLLM client using shared OpenAI-compatible types and encode/decode helpers.
...
pub fn loadFromEnv(allocator: std.mem.Allocator) !Config {
    const loaded = try shared.loadConfigFromEnv(allocator, .{
        .api_key_env = &.{ "ABI_VLLM_API_KEY", "VLLM_API_KEY" },
        .base_url_env = &.{},
        .model_env = &.{ "ABI_VLLM_MODEL", "VLLM_MODEL" },
