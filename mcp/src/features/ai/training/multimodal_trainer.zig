...
const l2Normalize = training_utils.l2Normalize;

/// Multimodal uses a distinct seed (0x87654321) from the vision encoder
/// to ensure text and vision encoders get independent initializations.
fn initializeXavier(data: []f32) void {
    training_utils.initializeXavierWithSeed(data, 0x87654321);
}
