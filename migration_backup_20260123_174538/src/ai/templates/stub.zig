//! Stub implementation for templates when feature is disabled.
//!
//! Provides API-compatible stubs that return TemplatesDisabled error.
...
pub fn getBuiltinTemplate(_: BuiltinTemplates) TemplateInfo {
    return .{
        .name = "",
        .description = "Templates feature is disabled",
        .source = "",
        .variables = &.{},
    };
}
