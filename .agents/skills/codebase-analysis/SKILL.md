...
description: This skill should be used when the user asks to find legacy patterns, technical debt, or modernization targets in ABI — e.g. 'where should we start modernizing this module', 'find outdated patterns in crates/', 'audit this file for tech debt' — before any refactor begins.
---
...
Base directory for this skill: /Users/donaldfilimon/dev/active/abi/.agents/skills/codebase-analysis
