...
- `zig build feature-tests --summary all`: run feature module inline tests (baseline: 1095 pass).
...
- **Test baselines**: 1251/1256 main (5 skip), 1095/1095 feature — must be maintained.
