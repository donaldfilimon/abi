...
- `zig build test --summary all`: run the full test suite (baseline: 1251 pass, 5 skip).
- `zig build feature-tests --summary all`: run feature module inline tests (baseline: 1153 pass).
...
- **Test baselines**: 1251/1256 main (5 skip), 1153/1153 feature — must be maintained.
