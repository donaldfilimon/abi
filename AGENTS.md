...
- `zig build feature-tests --summary all`: run feature module inline tests (baseline: 1198 pass).
...
- **Test baselines**: 1251/1256 main (5 skip), 1198/1198 feature — must be maintained.
