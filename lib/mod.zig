...
/// Initialise the framework from the high level configuration options.
pub fn initWithOptions(allocator: std.mem.Allocator, options: FrameworkOptions) !Framework {
