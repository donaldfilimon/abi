...
- No authenticated worker protocol exists yet. Registry-delivery security, `abi-model-runtime`, and `abi-worker` remain open and must preserve the frozen 13-command CLI and 12-tool MCP catalogs.
