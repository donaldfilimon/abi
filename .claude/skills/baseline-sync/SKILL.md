...
If the build fails due to the Darwin linker issue, ensure a host-built Zig matching `.zigversion` (`0.16.0-dev.2962+08416b44f`) is on PATH. The legacy `run_build.sh` wrapper has been removed.
