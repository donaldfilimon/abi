...
Language and library detail lives in the sibling skills: [types.md](types.md),
[errors.md](errors.md), [memory.md](memory.md), [comptime.md](comptime.md), [builtins.md](builtins.md), [std.md](std.md),
[io.md](io.md), [build.md](build.md), [testing.md](testing.md), [c-interop.md](c-interop.md).
