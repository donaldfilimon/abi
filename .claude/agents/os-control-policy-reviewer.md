...
description: Analyze abi's OS-control command policy — validation, the dry-run vs execute boundary, and the --confirm safety gate behind `abi agent os`. Use when working on crates/os_control/ or reviewing command-execution safety. Read-only; safety-sensitive.
tools: Read, Grep
---
