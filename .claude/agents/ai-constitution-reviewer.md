...
description: "Analyze abi's AI profile routing and constitution — Abbey/Aviva/Abi router weights, keyword heuristics, constitution principles, and EMA weight persistence. Use when working on `crates/abi-ai/src/router.rs` or `crates/abi-ai/src/constitution.rs`, or tuning profile selection. Read-only."
---
