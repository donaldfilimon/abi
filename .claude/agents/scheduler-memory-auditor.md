...
- `src/core/scheduler.zig` owns task submission/lifecycle; `src/core/memory.zig` is the MemoryTracker. The integration plan wires the tracker into AI (`crates/ai/mod.zig` training_support) and WDBX paths.
