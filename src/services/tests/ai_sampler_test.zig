...
const Sampler = if (build_options.feat_llm) abi.ai.llm.generation.sampler.Sampler else struct {};
const SamplerConfig = if (build_options.feat_llm) abi.ai.llm.generation.sampler.SamplerConfig else struct {};
const TopKTopP = if (build_options.feat_llm) abi.ai.llm.generation.sampler.TopKTopP else struct {};
