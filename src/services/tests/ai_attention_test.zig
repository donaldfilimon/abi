...
const attention = if (build_options.feat_llm) abi.ai.llm.ops.attention else struct {};
const activations = if (build_options.feat_llm) abi.ai.llm.ops.activations else struct {};
