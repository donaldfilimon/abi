...
const gpu_specs = [_]DeclSpec{
    ...
    .{ .name = "backends", .kind = .type_decl },
    .{ .name = "devices", .kind = .type_decl },
    .{ .name = "runtime", .kind = .type_decl },
    .{ .name = "policy", .kind = .type_decl },
    .{ .name = "multi", .kind = .type_decl },
    .{ .name = "factory", .kind = .type_decl },
