...
//! | ABI_LSP_ZLS_PATH | ZLS binary path override | auto (`zls` on PATH) |
//! | ABI_LSP_ZIG_EXE_PATH | Zig compiler path override for ZLS | auto (ZVM master, otherwise let ZLS resolve `zig`) |
