...
//! - `src/gpu/mega/coordinator.zig` - Cross-backend GPU coordination
//! - `src/gpu/mega/scheduler.zig` - Learning-based scheduling
//! - `src/ai/orchestration/mod.zig` - Multi-model AI orchestration
//!
//! ## Thread Safety
//!
