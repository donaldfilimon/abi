...
test "emotion detection - frustration" {
    ...
    try testing.expect(result.detected_emotion == .frustrated or
...
test "emotion detection - sadness" {
    ...
    try testing.expect(result.detected_emotion == .sad or
        result.detected_emotion == .disappointed);
}
...
test "emotion detection - joy" {
    ...
    try testing.expect(result.detected_emotion == .happy or
        result.detected_emotion == .excited);
}
