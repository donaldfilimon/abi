...
/// Physical device types for GPU selection
...
/// Physical device properties structure
...
/// Physical device limits (simplified - contains key compute limits)
pub const VkPhysicalDeviceLimits = extern struct {
    ...
    // ... remaining fields default to 0 for padding
    _padding: [256]u8 = [_]u8{0} ** 256,
};

/// Sparse properties (simplified)
