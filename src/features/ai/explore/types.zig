//! Type definitions for AI explore stub module.
...
pub const AdaptiveConfig = struct {
    ...
    pub const KvCacheType = enum { standard, sliding_window, paged };
};
...
pub const DependencyGraph = struct {
    ...
    pub const ModuleDependency = struct { module: Module, import_type: ImportType };
...
pub const ModelDiscovery = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, disc_config: DiscoveryConfig) @This() {
        return .{ .allocator = allocator, .config = disc_config, .discovered_models = .empty, .capabilities = detectCapabilities() };
    }
...
pub const FileMetadata = struct { path: []const u8 = "", size_bytes: usize = 0, line_count: usize = 0, chunk_count: usize = 0, last_indexed: i64 = 0 };
pub const CodeSnippet = struct { file_path: []const u8 = "", start_line: usize = 0, end_line: usize = 0, content: []const u8 = "", relevance_score: f32 = 0 };
...
pub const IndexResult = struct { files_indexed: usize = 0, total_chunks: usize = 0, total_lines: usize = 0, duration_ms: u64 = 0 };
pub const IndexStats = struct { file_count: usize = 0, total_chunks: usize = 0, total_size_bytes: usize = 0, index_path: []const u8 = "" };
