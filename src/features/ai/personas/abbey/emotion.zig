...
const EMOTION_PATTERNS = [_]EmotionPattern{
    ...
    .{ .pattern = "happy", .emotion = .enthusiastic, .weight = 0.7 },
    .{ .pattern = "glad", .emotion = .enthusiastic, .weight = 0.65 },
    .{ .pattern = "pleased", .emotion = .enthusiastic, .weight = 0.6 },
    ...
    .{ .pattern = "sad", .emotion = .disappointed, .weight = 0.8 },
    .{ .pattern = "unhappy", .emotion = .disappointed, .weight = 0.75 },
    .{ .pattern = "depressed", .emotion = .disappointed, .weight = 0.85 },
    .{ .pattern = "hopeless", .emotion = .disappointed, .weight = 0.9 },
    .{ .pattern = "down", .emotion = .disappointed, .weight = 0.6, .requires_context = true },
