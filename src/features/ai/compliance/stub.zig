...
//!
//! Provides API-compatible no-ops for the compliance engine, GDPR, HIPAA,
//! CCPA checkers, and audit trail when the feature is disabled.

const std = @import("std");

// ============================================================================
// Sub-module stubs (match mod.zig's `pub const config/gdpr/hipaa/ccpa/audit`)
// ============================================================================
...
// ============================================================================
// Re-exported core types (match mod.zig top-level re-exports)
// ============================================================================
...
const _ConsentRecord = struct {
    ...
    pub fn isValid(self: _ConsentRecord, now: i64) bool {
...
const _GdprCheckResult = struct {
    ...
    pub fn deinit(_: *_GdprCheckResult) void {}
};

const _GdprChecker = struct {
    pii_config: _PiiDetectionConfig,

    pub fn init(pii_cfg: _PiiDetectionConfig) _GdprChecker {
        return .{ .pii_config = pii_cfg };
    }

    pub fn check(_: *const _GdprChecker, _: std.mem.Allocator, _: []const u8) !_GdprCheckResult {
...
const _PhiMatch = struct {
    category: _PhiCategory,
    start: usize,
    length: usize,
    confidence: f32,
...
const _AccessLevel = enum {
    ...
    pub fn canAccess(self: _AccessLevel, required: _AccessLevel) bool {
...
const _HipaaCheckResult = struct {
    ...
    pub fn deinit(_: *_HipaaCheckResult) void {}
};

const _HipaaChecker = struct {
    pub fn init() _HipaaChecker {
        return .{};
    }

    pub fn check(_: *const _HipaaChecker, _: std.mem.Allocator, _: []const u8) !_HipaaCheckResult {
        return error.FeatureDisabled;
    }
};
...
const _CcpaCheckResult = struct {
    ...
    pub fn deinit(_: *_CcpaCheckResult) void {}
};

const _CcpaChecker = struct {
    pub fn init() _CcpaChecker {
        return .{};
    }

    pub fn check(_: *const _CcpaChecker, _: std.mem.Allocator, _: []const u8) !_CcpaCheckResult {
        return error.FeatureDisabled;
    }
};
...
const _AuditEvent = struct {
    ...
    pub fn getSubjectId(self: *const _AuditEvent) []const u8 {
        return self.subject_id[0..self.subject_id_len];
    }

    pub fn getDescription(self: *const _AuditEvent) []const u8 {
...
// ============================================================================
// Unified compliance check result (matches mod.zig)
// ============================================================================
...
pub const ComplianceCheckResult = struct {
    ...
    pub fn deinit(_: *ComplianceCheckResult) void {}
};

// ============================================================================
// Compliance Engine stub
// ============================================================================
...
pub const ComplianceEngine = struct {
    ...
    pub fn checkContent(_: *Self, _: []const u8, _: []const u8) !ComplianceCheckResult {
        return error.FeatureDisabled;
    }
