...
pub const PluginDispatchFn = repl.PluginDispatchFn;
pub const PluginSlashCommand = repl.PluginSlashCommand;
pub const matchPluginCommandToken = repl.matchPluginCommandToken;
pub const printPluginHelp = repl.printPluginHelp;
pub const formatContextStatus = repl.formatContextStatus;
...
pub const isTabKey = terminal.isTabKey;
pub const isScrollUpKey = terminal.isScrollUpKey;
pub const isScrollDownKey = terminal.isScrollDownKey;
