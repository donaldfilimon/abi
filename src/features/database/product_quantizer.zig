//! Product Quantization Module
//!
//! Provides product quantization (PQ) for high compression ratios on
//! high-dimensional vectors. Divides vectors into M subvectors, clusters
//! each subspace with K centroids, and stores only centroid IDs.
//! Achieves 97% compression (768-dim f32 -> ~96 bytes).
//!
