...
pub const abbey = @import("../ai/abbey/mod.zig");

pub const rag = if (build_options.enable_reasoning)
    @import("../ai/rag/mod.zig")
else
    @import("../ai/rag/stub.zig");

pub const eval = if (build_options.enable_reasoning)
    @import("../ai/eval/mod.zig")
else
    @import("../ai/eval/stub.zig");

pub const templates = if (build_options.enable_reasoning)
    @import("../ai/templates/mod.zig")
else
    @import("../ai/templates/stub.zig");

pub const explore = if (build_options.enable_explore)
    @import("../ai/explore/mod.zig")
else
    @import("../ai/explore/stub.zig");

pub const orchestration = if (build_options.enable_reasoning)
    @import("../ai/orchestration/mod.zig")
else
    @import("../ai/orchestration/stub.zig");

pub const documents = if (build_options.enable_reasoning)
    @import("../ai/documents/mod.zig")
else
    @import("../ai/documents/stub.zig");
