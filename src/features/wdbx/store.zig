...
const index = @import("hnsw.zig");
const storage = @import("chain.zig");
...
const AccelerationStatus = types.AccelerationStatus;
const StoreStats = types.StoreStats;
const StoreConfig = types.StoreConfig;
const SearchResult = types.SearchResult;
const ConversationBlock = types.ConversationBlock;
