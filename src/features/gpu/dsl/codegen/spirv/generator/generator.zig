//! SPIR-V Generator Logic
//!
//! SpirvGenerator implementation moved from generator.zig.
...
const SPIRV_VERSION = spec.SPIRV_VERSION;
const GENERATOR_ID = spec.GENERATOR_ID;

const OpCode = spec.OpCode;
const BuiltIn = spec.BuiltIn;
const MemorySemantics = spec.MemorySemantics;
const Scope = spec.Scope;

const TypeKey = types_gen.TypeKey;
const ConstKey = constants_gen.ConstKey;
