...
//! Provides methods for creating and caching SPIR-V type declarations.
...
/// Type code generation mixin for SpirvGenerator.
/// Provides methods for creating and caching SPIR-V types.
pub fn TypeCodeGenMixin(comptime Self: type) type {
    return struct {
