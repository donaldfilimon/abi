//! Vulkan type definitions and constants.
//!
//! Contains all Vulkan API type definitions, struct layouts, enums,
//! and constants used by the Vulkan backend implementation.
...
/// Vulkan physical device types for device classification.
...
/// Physical device properties returned by vkGetPhysicalDeviceProperties.
...
/// Subset of physical device limits we care about for compute.
...
/// Sparse properties (not heavily used but needed for struct layout).
