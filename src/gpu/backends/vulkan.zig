...
// Function pointers (stub: all null)
...
pub const VulkanInitConfig = struct {
    ...
    preferred_device_type: ?anyopaque = null,
...
pub fn initWithConfig(_: VulkanInitConfig) !void {
    vulkan_initialized = true;
}
...
pub fn findMemoryType(_: u32, _: u32) VulkanError!u32 {
    return VulkanError.NotFound;
}

pub fn findDeviceLocalMemoryType() VulkanError!u32 {
    return VulkanError.NotFound;
}

pub fn findHostVisibleMemoryType() VulkanError!u32 {
    return VulkanError.NotFound;
}
...
pub const KernelCompileOptions = struct { dummy: bool = false };
pub const LaunchOptions = struct { dummy: bool = false };
pub const KernelError = error{ CompilationFailed, LaunchFailed };

pub fn compileKernel(_: std.mem.Allocator, _: anytype) KernelError!*anyopaque {
    return KernelError.CompilationFailed;
}

pub fn compileKernelEx(_: std.mem.Allocator, _: anytype, _: KernelCompileOptions) KernelError!*anyopaque {
    return KernelError.CompilationFailed;
}

pub fn launchKernel(_: std.mem.Allocator, _: *anyopaque, _: anytype, _: []const ?*anyopaque) KernelError!void {
    return KernelError.LaunchFailed;
}

pub fn launchKernelEx(_: std.mem.Allocator, _: *anyopaque, _: anytype, _: []const ?*anyopaque, _: LaunchOptions) KernelError!void {
    return KernelError.LaunchFailed;
}
...
pub const MemoryLocation = enum { device_local, host_visible, host_coherent };

pub fn allocateDeviceMemory(_: usize) error{OutOfMemory}!*anyopaque {
    return error.OutOfMemory;
}

pub fn allocateDeviceMemoryEx(_: usize, _: MemoryLocation) error{OutOfMemory}!*anyopaque {
    return error.OutOfMemory;
}

pub fn allocateStagingBuffer(_: usize) error{OutOfMemory}!*anyopaque {
    return error.OutOfMemory;
}

pub fn freeDeviceMemory(_: *anyopaque) void {}

pub fn memcpyHostToDevice(_: *anyopaque, _: *anyopaque, _: usize) error{OutOfMemory}!void {}

pub fn memcpyDeviceToHost(_: *anyopaque, _: *anyopaque, _: usize) error{OutOfMemory}!void {}
