...
pub fn buildKernelIR(allocator: std.mem.Allocator, kernel_type: BuiltinKernel) !*const KernelIR {
    return switch (kernel_type) {
        ...
        // Vision operations
        .conv2d => buildConv2dKernel(allocator),
        .max_pool2d => buildMaxPool2dKernel(allocator),
        .avg_pool2d => buildAvgPool2dKernel(allocator),
        .batch_norm2d => buildBatchNorm2dKernel(allocator),
        .im2col => buildIm2colKernel(allocator),
        .col2im => buildCol2imKernel(allocator),
    };
}
