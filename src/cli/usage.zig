...
pub const commands = [_]Command{
    ...
    .{
        .name = "agent",
        .usage = "abi agent <plan|train|tui|os> ...",
        .summary = "Plan, train, launch TUI, or run OS-control dry-runs",
        .category = .ai,
        .details = "Subcommands: plan <input>, train <abbey|aviva|abi|all>, tui, os dry-run <cmd>, os execute --confirm <cmd>.",
        .examples = &.{
