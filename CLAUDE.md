...
| **Version** | 0.4.0 |
| **Test baseline** | 1284 pass, 6 skip (1290 total) — must be maintained |
| **Feature tests** | 2264 pass (2269 total), 5 skip — `zig build feature-tests` |
...
| Feature inline tests | `zig build feature-tests --summary all` (must stay at 2264+) |
...
**Main tests**: 1284 pass, 6 skip (1290 total) — `zig build test --summary all`
**Feature tests**: 2264 pass (2269 total), 5 skip — `zig build feature-tests --summary all`
