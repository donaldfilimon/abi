//! `mobile-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/mobile-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `mobile-plugin` stub used when its feature gate is off.
pub struct Stub;
