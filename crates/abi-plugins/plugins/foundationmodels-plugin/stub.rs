//! `foundationmodels-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/foundationmodels-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `foundationmodels-plugin` stub used when its feature gate is off.
pub struct Stub;
