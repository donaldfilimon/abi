//! `nn-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/nn-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `nn-plugin` stub used when its feature gate is off.
pub struct Stub;
