//! `metrics-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/metrics-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `metrics-plugin` stub used when its feature gate is off.
pub struct Stub;
