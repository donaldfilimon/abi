//! `tui-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/tui-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `tui-plugin` stub used when its feature gate is off.
pub struct Stub;
