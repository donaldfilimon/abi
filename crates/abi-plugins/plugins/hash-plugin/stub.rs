//! `hash-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/hash-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `hash-plugin` stub used when its feature gate is off.
pub struct Stub;
