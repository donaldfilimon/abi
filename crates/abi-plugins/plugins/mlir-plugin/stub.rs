//! `mlir-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/mlir-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `mlir-plugin` stub used when its feature gate is off.
pub struct Stub;
