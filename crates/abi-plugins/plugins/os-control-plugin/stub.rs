//! `os-control-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/os-control-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `os-control-plugin` stub used when its feature gate is off.
pub struct Stub;
