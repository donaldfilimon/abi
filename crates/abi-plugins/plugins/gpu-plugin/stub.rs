//! `gpu-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/gpu-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `gpu-plugin` stub used when its feature gate is off.
pub struct Stub;
