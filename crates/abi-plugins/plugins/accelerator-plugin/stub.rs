//! `accelerator-plugin` — disabled-feature stub.
//!
//! Ported from `src/plugins/accelerator-plugin/stub.zig`. Metadata is identical to
...
/// The no-op `accelerator-plugin` stub used when its feature gate is off.
pub struct Stub;
