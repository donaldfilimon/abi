...
RUN curl -L https://ziglang.org/builds/zig-linux-x86_64-0.16.0-dev.427+86077fe6b.tar.xz | tar -xJ -C /opt
ENV PATH="/opt/zig-linux-x86_64-0.16.0-dev.427+86077fe6b:$PATH"
