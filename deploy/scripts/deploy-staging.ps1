...
RUN curl -L https://ziglang.org/builds/zig-x86_64-linux-0.16.0-dev.457+f90510b08.tar.xz | tar -xJ -C /opt
ENV PATH="/opt/zig-x86_64-linux-0.16.0-dev.457+f90510b08:$PATH"
