...
const ai_agents = @import("../src/ai/enhanced_agent.zig");
const ai_neural = @import("../src/ai/neural.zig");
const vector_database = @import("../src/wdbx/database.zig");
const gpu_backend = @import("../src/gpu/core/backend.zig");
const web_server = @import("../src/server/enhanced_web_server.zig");
const plugin_system = @import("../src/plugins/enhanced_plugin_system.zig");
