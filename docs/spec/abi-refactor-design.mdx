...
**Date:** 2026-07-10
**Status:** Implemented baseline; refreshed against current source layout (includes local `agent multi|spawn|browser` orchestration)
...
│   ├── registry.zig   # Command definitions and handler wiring
