...
- **Proposed:** production multi-host deployment, TLS/mTLS or equivalent fronting network policy, dynamic membership, and data sharding/partitioning across nodes. Until those are exercised, ABI is **not** a production distributed multi-host system, and sharding is unbuilt.
