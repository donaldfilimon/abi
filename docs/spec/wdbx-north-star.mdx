...
WDBX Runtime
 ...
 ├─ Compute Layer       (Partial — CPU SIMD + macOS Metal fused cosine/dot/L2 + CPU fallback + CPU/GPU parity; ANE detection; TPU remote-dispatch transport)
