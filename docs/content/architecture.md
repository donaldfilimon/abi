...
|-----------|------|---------|
| Main tests | `src/services/tests/mod.zig` | Integration, stress, chaos, parity tests (1248 pass) |
| Feature tests | `src/feature_test_root.zig` | Inline tests inside feature/service modules (1086 pass) |
