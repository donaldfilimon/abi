---
title: Mobile
description: Mobile lifecycle, sensors, and notifications
...
# Mobile
## Summary
Mobile lifecycle, sensors, and notifications
...
- **mobile** — Mobile platform support
  - Build flag: `enable_mobile`
  - Source: `src/features/mobile/mod.zig`
