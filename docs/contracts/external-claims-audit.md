...
| MCP/CLI | `src/cli/usage.zig`, `src/mcp/handlers.zig`, contract tests | Public CLI commands and MCP tools are small, frozen surfaces guarded by contract tests. |
