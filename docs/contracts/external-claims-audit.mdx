...
| --- | --- | --- |
| Toolchain | `.zigversion`, `build.zig`, README quick start | ABI targets Zig `0.17.0-dev.1398+cb5635714` (pin); `build.zig.zon` minimum is Zig `0.17.0-dev.1252+e4b325c19`. Older Zig 0.16 wording is stale. |
