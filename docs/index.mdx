...
<CardGroup cols={2}>
  ...
  <Card title="WDBX (Rust) Capability Extract (PARTIAL)" href="spec/wdbx-rust-capability-extract">
    Design reference extract; not a claim of a Rust implementation in-tree.
  </Card>
</CardGroup>
