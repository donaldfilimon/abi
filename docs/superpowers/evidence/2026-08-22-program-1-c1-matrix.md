...
| `donaldfilimon/abbey` | `ba7fc2a8a5cdf29b307f7df006ca2a483efe3c80` | Rust nightly `1.100.0-nightly (e71c0f1e3 2026-08-18)` | 3/3 corpus integration tests plus the C1 claim test; all 52 declared fixtures matched | `./check.sh` passed default, WDBX, personal, accelerator, clippy, rustdoc, claim/docs, Metal parity, install, and rollback smoke | [PR #89](https://github.com/donaldfilimon/abbey/pull/89) merged the corpus as `43317c7b49a9e9e915d68129e4b308926e300b84`; its macOS adjunct exposed ambient ABI-provider leakage in daemon fixtures. The isolated repair passed locally and in [PR #91](https://github.com/donaldfilimon/abbey/pull/91), merged as `7b9618ca76135185f19a6a0fe73dd821287151db`; the post-merge main run `32605868639` passed. Linux ARM64 and the hosted-fork job were guard-skipped, so they are not claimed as execution evidence. |
