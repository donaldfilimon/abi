...
Pinned at Zig `0.17.0-dev.304+9787df942` (`.zigversion`), package version `0.1.0` (`build.zig.zon`). The build.zig is **self-contained** — no external build/ modules.
...
1. Check the pinned version: read `.zigversion` (should contain `0.17.0-dev.304+9787df942`).
