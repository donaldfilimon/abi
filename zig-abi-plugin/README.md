# zig-abi-plugin v0.8.0

Claude Code plugin for ABI Framework development. Provides smart build routing, Zig 0.16 patterns, feature module scaffolding, WDBX vector database MCP integration, build troubleshooting, CLI development guidance, testing patterns, and real-time verification.
...
| `/zig-abi:new-feature <name>` | Scaffold new feature module (10-step process) |
...
| `cli-development` | CLI commands, registry updates, argument parsing |
| `feature-scaffolding` | Creating new feature modules, mod/stub/types structure |
| `testing-patterns` | Test discovery, feature tests, integration tests, test helpers |
...
The ABI Framework uses comptime feature gating with 27 `feat_*` flags and 58 validated combos. Key flags:
...
1. Host-built Zig matching `.zigversion`
